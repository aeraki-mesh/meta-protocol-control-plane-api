...
import (
	...
	v31 "github.com/envoyproxy/go-control-plane/envoy/extensions/common/ratelimit/v3"
...
type LocalRateLimit struct {
	...
	Match       *LocalRatelimitMatch            `protobuf:"bytes,2,opt,name=match,proto3" json:"match,omitempty"`
	TokenBucket *v3.TokenBucket                 `protobuf:"bytes,3,opt,name=token_bucket,json=tokenBucket,proto3" json:"token_bucket,omitempty"`
	Descriptors []*v31.LocalRateLimitDescriptor `protobuf:"bytes,4,rep,name=descriptors,proto3" json:"descriptors,omitempty"`
}
...
func (x *LocalRateLimit) GetMatch() *LocalRatelimitMatch {
	if x != nil {
		return x.Match
	}
	return nil
...
func (x *LocalRateLimit) GetDescriptors() []*v31.LocalRateLimitDescriptor {
	if x != nil {
...
type LocalRatelimitMatch struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Metadata []*v32.HeaderMatcher `protobuf:"bytes,1,rep,name=metadata,proto3" json:"metadata,omitempty"`
}

func (x *LocalRatelimitMatch) Reset() {
	*x = LocalRatelimitMatch{}
	if protoimpl.UnsafeEnabled {
...
func (x *LocalRatelimitMatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LocalRatelimitMatch) ProtoMessage() {}

func (x *LocalRatelimitMatch) ProtoReflect() protoreflect.Message {
	mi := &file_api_meta_protocol_proxy_filters_local_ratelimit_v1alpha_local_ratelimit_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LocalRatelimitMatch.ProtoReflect.Descriptor instead.
func (*LocalRatelimitMatch) Descriptor() ([]byte, []int) {
	return file_api_meta_protocol_proxy_filters_local_ratelimit_v1alpha_local_ratelimit_proto_rawDescGZIP(), []int{1}
}

func (x *LocalRatelimitMatch) GetMetadata() []*v32.HeaderMatcher {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_api_meta_protocol_proxy_filters_local_ratelimit_v1alpha_local_ratelimit_proto_rawDesc = []byte{
	...
	0x6e, 0x5f, 0x62, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x34,
	...
	0x74, 0x2f, 0x76, 0x33, 0x2f, 0x72, 0x61, 0x74, 0x65, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x2e, 0x70,
	...
	0x64, 0x61, 0x74, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc2, 0x02, 0x0a, 0x0e, 0x4c,
	...
	,
	...
	0x52, 0x0b, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x42, 0x75, 0x63, 0x6b, 0x65, 0x74, 0x12, 0x60, 0x0a,
	...
	0x57, 0x0a, 0x13, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x52, 0x61, 0x74, 0x65, 0x6c, 0x69, 0x6d, 0x69,
	0x74, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x12, 0x40, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x65, 0x6e, 0x76, 0x6f, 0x79,
	0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x72, 0x6f, 0x75, 0x74, 0x65, 0x2e, 0x76, 0x33,
	0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x72, 0x52, 0x08,
	0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x5e, 0x0a, 0x3d, 0x69, 0x6f, 0x2e, 0x61,
	...
	0x73, 0x2e, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x6c, 0x69, 0x6d, 0x69,
	0x74, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x42, 0x13, 0x4c, 0x6f, 0x63, 0x61, 0x6c,
...
var file_api_meta_protocol_proxy_filters_local_ratelimit_v1alpha_local_ratelimit_proto_goTypes = []interface{}{
	...
	(*LocalRatelimitMatch)(nil),          // 1: aeraki.meta_protocol_proxy.filters.local_ratelimit.v1alpha.LocalRatelimitMatch
	(*v3.TokenBucket)(nil),               // 2: envoy.type.v3.TokenBucket
	(*v31.LocalRateLimitDescriptor)(nil), // 3: envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor
	(*v32.HeaderMatcher)(nil),            // 4: envoy.config.route.v3.HeaderMatcher
}
var file_api_meta_protocol_proxy_filters_local_ratelimit_v1alpha_local_ratelimit_proto_depIdxs = []int32{
	1, // 0: aeraki.meta_protocol_proxy.filters.local_ratelimit.v1alpha.LocalRateLimit.match:type_name -> aeraki.meta_protocol_proxy.filters.local_ratelimit.v1alpha.LocalRatelimitMatch
	2, // 1: aeraki.meta_protocol_proxy.filters.local_ratelimit.v1alpha.LocalRateLimit.token_bucket:type_name -> envoy.type.v3.TokenBucket
	3, // 2: aeraki.meta_protocol_proxy.filters.local_ratelimit.v1alpha.LocalRateLimit.descriptors:type_name -> envoy.extensions.common.ratelimit.v3.LocalRateLimitDescriptor
	4, // 3: aeraki.meta_protocol_proxy.filters.local_ratelimit.v1alpha.LocalRatelimitMatch.metadata:type_name -> envoy.config.route.v3.HeaderMatcher
...
func file_api_meta_protocol_proxy_filters_local_ratelimit_v1alpha_local_ratelimit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_meta_protocol_proxy_filters_local_ratelimit_v1alpha_local_ratelimit_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LocalRatelimitMatch); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
